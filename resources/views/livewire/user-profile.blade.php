    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-9 col-md-8">{{$user_data->name ?? 'N/A'}}</div>
    </div>

    <div class="row mb-3">
        <div class="col-lg-3 col-md-4 label fw-bold">Company</div>
        <div class="col-lg-9 col-md-8">{{$user_data->company ?? 'N/A'}}</div>
    </div>

    <div class="row mb-3">
        <div class="col-lg-3 col-md-4 label fw-bold">Job</div>
        <div class="col-lg-9 col-md-8">{{$user_data->job ?? 'N/A'}}</div>
    </div>

    <div class="row mb-3">
        <div class="col-lg-3 col-md-4 label fw-bold">Country</div>
        <div class="col-lg-9 col-md-8">{{$user_data->country ?? 'N/A'}}</div>
    </div>

    <div class="row mb-3">
        <div class="col-lg-3 col-md-4 label fw-bold">Address</div>
        <div class="col-lg-9 col-md-8">{{$user_data->address ?? 'N/A'}}</div>
    </div>

    <div class="row mb-3">
        <div class="col-lg-3 col-md-4 label fw-bold">Phone</div>
        <div class="col-lg-9 col-md-8">{{ $user_data->phone ? '(94) '.$user_data->phone : 'N/A' }}</div>
    </div>

    <div class="row mb-3">
        <div class="col-lg-3 col-md-4 label fw-bold">Email</div>
        <div class="col-lg-9 col-md-8">{{$user_data->email ?? 'N/A'}}</div>
    </div>
